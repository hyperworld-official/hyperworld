...
main-notice =
    Benvenuto nella versione Alpha di Hyperworld!
    ...
    - Hyperworld è concesso in licenza con la licenza open-source GPL 3. Il che vuol dire che sei libero di giocare, modificare e ridistribuire il gioco come
     tu desideri (purché il lavoro che ne derivi sia sempre sotto licenza GPL 3).
    
    - Hyperworld è un progetto comunitario no-profit, e chiunque ci lavori sopra è un volontario.
    ...
    ~ Il team di sviluppo di Hyperworld
main-login_process =
...
loading-tips =
    ...
    .a14 = Hyperworld è ancora in pre-alpha. Facciamo del nostro meglio per migliorarlo ogni giorno!
