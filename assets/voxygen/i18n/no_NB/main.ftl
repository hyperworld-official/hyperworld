...
main-tip = Tips:
main-notice =
    Velkommen til alfaversjonen av Hyperworld!
    ...
    - Hyperworld er lisensiert under GPL 3 åpen kildekode-lisensen. Det betyr at du er fri til å spille, endre og distribuere spillet på nytt, akkurat
     som du ønsker (så lenge arbeidet også er under GPL 3).
    
    - Hyperworld er et ikke-profitt basert samfunnsprosjekt, og alle som jobber på prosjektet er frivillige.
...
loading-tips =
    ...
    .a15 = Hyperworld er fortsatt i Pre-Alfa. Vi gjør vårt beste for å forbedre det hver dag!
