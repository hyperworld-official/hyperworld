...
main-notice =
    Witaj w wersji alfa Hyperworld!
    ...
    - Hyperworld jest objęte licencją typu open-source 'GNU GPLv3'.
    ...
    - Hyperworld jest projektem non-profit, w całości tworzonym przez wolontariuszy w wolnym czasie.
    Jeśli polubisz Hyperworld, zapraszamy cię do dołączenia do naszego zespołu! Nowi programiści, artyści, tłumacze i inni są zawsze mile widziani!
    
    Dziękujemy za przeczytanie tej notki i życzymy miłej gry!
    
    ~ Zespół Twórców Hyperworld
main-login_process =
...
loading-tips =
    ...
    .a14 = Hyperworld dalej jest w fazie Pre-Alpha. Staramy się ulepszać go dzień w dzień!
