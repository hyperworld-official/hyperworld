...
main-notice =
    Bem vindo a versão alpha de Hyperworld!
    ...
    Discord.
    - Hyperworld está licenciado sob a licensa código aberto GPL 3. Isto significa que pode jogar, modificar e redistribuir como quiser
     (Contanto que o trabalho derivado seja também GPL 3).
    - Hyperworld é um projeto comunitário sem lucro, e toda a gente que trabalha nele é um voluntário. Se gostar do que ve, considere juntar-se a equipa
