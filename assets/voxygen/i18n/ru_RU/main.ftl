...
main-notice =
    Добро пожаловать в альфа версию Hyperworld!
    ...
    - Hyperworld лицензирован по лицензии GPL 3 с открытым исходным кодом. Это означает, что вы можете играть, изменять и распространять игру
    по своему усмотрению (при условии, что производная работа также находится в рамках GPL 3).
    
    - Hyperworld - это некоммерческий общественный проект, и все, кто работает над ним, являются добровольцами.
...
loading-tips =
    ...
    .a14 = Hyperworld все еще находится в Пре-Альфе. Мы делаем всё возможное, чтобы улучшать его каждый день!
