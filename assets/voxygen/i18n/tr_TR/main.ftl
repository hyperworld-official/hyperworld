...
main-notice =
    ...
    - Hyperworld GPL 3 açık kaynak lisansı ile lisanslıdır. Bunun anlamı, oyunu istediğin gibi oynayabilir, değiştirebilir ve dağıtabilirsin
    (türetilmiş çalışmalarda GPL 3 ile lisanslanmış olduğu sürece)
    
    - Hyperworld kar gütmeyen bir topluluk projesidir ve üzerinde çalışan herkes birer gönüllüdür.
...
main-login_process =
    ...
    https://hyperworld.net/account/ adresinden
...
loading-tips =
    ...
    .a14 = Hyperworld hala Pre-Alpha'da. Onu geliştirmek için her gün elimizden geleni yapıyoruz!
