...
main-notice =
    Вітаємо в альфа-версії Hyperworld!
    ...
    - Hyperworld розповсюджується під ліцензією GPL 3. Це означає, що Ви вільні грати, модифікувати та розповсюджувати
     гру як забажаєте (за умови, що Ваші допрацювання поширюватимуться також під GPL 3)
    
    - Hyperworld - це неприбутковий проект, і всі, хто над ним працюють - волонтери.
...
loading-tips =
    ...
    .a14 = Hyperworld все ще на стадії ранньої альфи. Ми стараємося робити покращення кожного дня!
