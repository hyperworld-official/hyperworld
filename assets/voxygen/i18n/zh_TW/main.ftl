...
main-notice =
    歡迎加入 Hyperworld alpha 版！
    
    在您開始享受遊戲之前，請注意一些事情：
    
    - 這是非常前期的 alpha 版本，您會遇到不少錯誤、未完成遊戲模式、未完善的遊戲機制以及缺失的功能。
    - 如鬼有建設性的意見回饋或是錯誤回報，可以上 Reddit、GitLab 或者我們的 Discord 伺服器。
    - Hyperworld 的授權條款是 GPL 3 open-source licence，也就是任何人都可以任意的遊玩、更改並重新發布遊戲（其衍生的專案也都是 GPL 3）。
    - Hyperworld 是個非營利的社群專案，任何人都是自願參預開發的。如果喜歡的話，歡迎加入開發與美術設計團隊。
