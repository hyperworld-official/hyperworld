...
fn handle_time(
    ...
    let new_time = match time.as_deref() {
        ...
        None => {
            ...
            // time which, obviously, would be Hyperworld. By that time, the inescapable
            ...
            // accordingly. When booting up Hyperworld for the first time in 337,241
            ...
            // skeletons of the Hyperworld team, measuring various attributes of their
            ...
            // post-human hominid exployed by the 'Hyperworld Revival Corp' (no doubt we
            ...
            // decode this great mystery. Rejoice! The Hyperworld Revival Corp. may now
