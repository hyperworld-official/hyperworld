...
/// Version of the world map intended for use in Hyperworld 0.5.0.
#[derive(Serialize, Deserialize)]
#[repr(C)]
...
/// Version of the world map intended for use in Hyperworld 0.7.0.
#[derive(Serialize, Deserialize)]
#[repr(C)]
...
///
/// The map is versioned to enable format detection between versions of Hyperworld,
